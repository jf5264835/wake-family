...
export function AdminApp({ user }: { user: { id: string; name: string; email: string; isAdmin: boolean; permissions: AdminPermissions; groupIds: string[] } }) {
  ...
  return (
    <main className="admin-shell">
      <aside className="admin-sidebar">
        ...
        <div className="admin-user"><span>{user.name}</span><small>{user.email}</small></div>
      </aside>
